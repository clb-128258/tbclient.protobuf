...
public final class InspirationTopicCardLayout extends Message {
  ...
  public InspirationTopicCardLayout(Builder paramBuilder, boolean paramBoolean) {
    super(paramBuilder);
    List<String> list;
  ...
  public static final class Builder extends Message.Builder<InspirationTopicCardLayout> {
    ...
    public Builder(InspirationTopicCardLayout param1InspirationTopicCardLayout) {
      super(param1InspirationTopicCardLayout);
      if (param1InspirationTopicCardLayout == null)
        return; 
      this.components = Message.copyOf(param1InspirationTopicCardLayout.components);
      this.business_info = Message.copyOf(param1InspirationTopicCardLayout.business_info);
      this.log_param = Message.copyOf(param1InspirationTopicCardLayout.log_param);
      this.schema = param1InspirationTopicCardLayout.schema;
      this.prefetch_schema = Message.copyOf(param1InspirationTopicCardLayout.prefetch_schema);
    }
    
    public InspirationTopicCardLayout build(boolean param1Boolean) {
      return new InspirationTopicCardLayout(this, param1Boolean, null);
    }
  }
