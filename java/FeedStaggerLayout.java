...
public final class FeedStaggerLayout extends Message {
  ...
  public FeedStaggerLayout(Builder paramBuilder, boolean paramBoolean) {
    super(paramBuilder);
    List<String> list;
  ...
  public static final class Builder extends Message.Builder<FeedStaggerLayout> {
    ...
    public Builder(FeedStaggerLayout param1FeedStaggerLayout) {
      super(param1FeedStaggerLayout);
      if (param1FeedStaggerLayout == null)
        return; 
      this.components = Message.copyOf(param1FeedStaggerLayout.components);
      this.schema = param1FeedStaggerLayout.schema;
      this.log_info = Message.copyOf(param1FeedStaggerLayout.log_info);
      this.feedback = param1FeedStaggerLayout.feedback;
      this.business_info = Message.copyOf(param1FeedStaggerLayout.business_info);
      this.log_param = Message.copyOf(param1FeedStaggerLayout.log_param);
      this.background = param1FeedStaggerLayout.background;
      this.prefetch_schema = Message.copyOf(param1FeedStaggerLayout.prefetch_schema);
    }
    
    public FeedStaggerLayout build(boolean param1Boolean) {
      return new FeedStaggerLayout(this, param1Boolean, null);
    }
  }
