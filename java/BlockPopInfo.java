...
public final class BlockPopInfo extends Message {
  ...
  public BlockPopInfo(Builder paramBuilder, boolean paramBoolean) {
    ...
    if (paramBoolean == true) {
      ...
      str1 = paramBuilder.is_like;
      if (str1 == null) {
        this.is_like = "";
      } else {
        this.is_like = str1;
      } 
      str1 = paramBuilder.is_nclass;
      if (str1 == null) {
        this.is_nclass = "";
      } else {
        this.is_nclass = str1;
      ...
      this.is_nclass = ((Builder)str).is_nclass;
  ...
  public static final class Builder extends Message.Builder<BlockPopInfo> {
    ...
    public Builder(BlockPopInfo param1BlockPopInfo) {
      ...
      this.is_like = param1BlockPopInfo.is_like;
      this.is_nclass = param1BlockPopInfo.is_nclass;
