...
| [`tbclient.protobuf`](https://github.com/clb-128258/tbclient.protobuf)   | [`tbclient`](https://github.com/clb-128258/tbclient.protobuf/tree/tbclient) | 244 个历史版本中提取的`.java/.proto`文件                                                                                |
...
| 路径                                  | 其文件用途                                                                                                                                                                                                   |
|-------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| java                                | 使用 [dex2jar](https://github.com/ThexXTURBOXx/dex2jar) 与 [jd-cli](https://github.com/intoolswetrust/jd-cli) 反编译贴吧客户端 apk 后取出 tbclient 根命名空间下的 `.class` 源码文件 |
