...
public final class LiveAnswer extends Message {
  ...
  public static final class Builder extends Message.Builder<LiveAnswer> {
    ...
    public Builder(LiveAnswer param1LiveAnswer) {
      ...
      this.activity_id = param1LiveAnswer.activity_id;
      this.show_statistics_urls = Message.copyOf(param1LiveAnswer.show_statistics_urls);
      this.click_statistics_urls = Message.copyOf(param1LiveAnswer.click_statistics_urls);
      this.scheme = param1LiveAnswer.scheme;
      this.package_name = param1LiveAnswer.package_name;
      this.download_info = param1LiveAnswer.download_info;
    }
