...
public final class DataRes extends Message {
  ...
  public DataRes(Builder paramBuilder, boolean paramBoolean) {
    ...
    if (paramBoolean == true) {
      ...
      List<SubPostList> list1 = paramBuilder.subpost_list;
      if (list1 == null) {
        this.subpost_list = DEFAULT_SUBPOST_LIST;
      } else {
        this.subpost_list = Message.immutableCopyOf(list1);
      } 
      this.thread = paramBuilder.thread;
      this.forum = paramBuilder.forum;
      Integer integer = paramBuilder.server_time;
      if (integer == null) {
        this.server_time = DEFAULT_SERVER_TIME;
      } else {
        this.server_time = integer;
      } 
      ...
      this.post = ((Builder)list).post;
      this.subpost_list = Message.immutableCopyOf(((Builder)list).subpost_list);
      this.thread = ((Builder)list).thread;
      this.forum = ((Builder)list).forum;
      this.server_time = ((Builder)list).server_time;
      this.display_forum = ((Builder)list).display_forum;
