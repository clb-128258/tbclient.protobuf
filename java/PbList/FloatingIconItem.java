...
public final class FloatingIconItem extends Message {
  ...
  public FloatingIconItem(Builder paramBuilder, boolean paramBoolean) {
    ...
    if (paramBoolean == true) {
      ...
      str1 = paramBuilder.display_ad_icon;
      if (str1 == null) {
        this.display_ad_icon = "";
      } else {
        this.display_ad_icon = str1;
      } 
      str1 = paramBuilder.hide_close_icon;
      if (str1 == null) {
        this.hide_close_icon = "";
      } else {
        this.hide_close_icon = str1;
      } 
      str = paramBuilder.activity_id;
      if (str == null) {
        this.activity_id = "";
      } else {
      ...
      this.hide_close_icon = ((Builder)str).hide_close_icon;
  ...
  public static final class Builder extends Message.Builder<FloatingIconItem> {
    ...
    public Builder(FloatingIconItem param1FloatingIconItem) {
      ...
      this.hide_close_icon = param1FloatingIconItem.hide_close_icon;
      this.activity_id = param1FloatingIconItem.activity_id;
    }
