...
public final class PollInfo extends Message {
  ...
  public PollInfo(Builder paramBuilder, boolean paramBoolean) {
    ...
    if (paramBoolean == true) {
      ...
      integer5 = paramBuilder.is_multi;
      if (integer5 == null) {
        this.is_multi = DEFAULT_IS_MULTI;
      } else {
        this.is_multi = integer5;
      } 
      ...
      Integer integer4 = paramBuilder.options_count;
      if (integer4 == null) {
        this.options_count = DEFAULT_OPTIONS_COUNT;
      } else {
        this.options_count = integer4;
      } 
      integer4 = paramBuilder.is_polled;
      if (integer4 == null) {
        this.is_polled = DEFAULT_IS_POLLED;
      } else {
        this.is_polled = integer4;
      } 
      ...
      Integer integer3 = paramBuilder.end_time;
      if (integer3 == null) {
        this.end_time = DEFAULT_END_TIME;
      } else {
        this.end_time = integer3;
      } 
      List<PollOption> list1 = paramBuilder.options;
      if (list1 == null) {
        this.options = DEFAULT_OPTIONS;
      } else {
        this.options = Message.immutableCopyOf(list1);
      } 
      ...
      Integer integer1 = paramBuilder.last_time;
      if (integer1 == null) {
