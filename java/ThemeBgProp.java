...
public final class ThemeBgProp extends Message {
  ...
  public ThemeBgProp(Builder paramBuilder, boolean paramBoolean) {
    ...
    if (paramBoolean == true) {
      ...
      str1 = paramBuilder.dynamic_url_small;
      if (str1 == null) {
        this.dynamic_url_small = "";
      } else {
        this.dynamic_url_small = str1;
      } 
      ...
      this.example_url = paramBuilder.example_url;
      this.permission = paramBuilder.permission;
      this.props_state_img = paramBuilder.props_state_img;
      this.in_use = paramBuilder.in_use;
      this.free_user_level = paramBuilder.free_user_level;
      this.activity_url = paramBuilder.activity_url;
      this.is_finished = paramBuilder.is_finished;
      this.dynamic_url = paramBuilder.dynamic_url;
      this.dynamic_url_small = paramBuilder.dynamic_url_small;
      this.bubble_v2 = paramBuilder.bubble_v2;
    } 
  }
  ...
  public static final class Builder extends Message.Builder<ThemeBgProp> {
    ...
    public Builder(ThemeBgProp param1ThemeBgProp) {
      ...
      this.bubble_v2 = param1ThemeBgProp.bubble_v2;
    }
