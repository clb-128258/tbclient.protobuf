...
public final class HeadImgs extends Message {
  ...
  public HeadImgs(Builder paramBuilder, boolean paramBoolean) {
    ...
    if (paramBoolean == true) {
      ...
      List<VideoImageColor> list = paramBuilder.video_image_color;
      if (list == null) {
      ...
      this.pc_url = ((Builder)integer).pc_url;
      this.title = ((Builder)integer).title;
      this.subtitle = ((Builder)integer).subtitle;
      ...
      this.has_second_page = ((Builder)integer).has_second_page;
      this.package_name = ((Builder)integer).package_name;
      this.download_is_thirdpage = ((Builder)integer).download_is_thirdpage;
      ...
      this.cover_image_color = ((Builder)integer).cover_image_color;
      this.video_image_color = Message.immutableCopyOf(((Builder)integer).video_image_color);
