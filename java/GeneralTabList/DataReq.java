...
public final class DataReq extends Message {
  ...
  public DataReq(Builder paramBuilder, boolean paramBoolean) {
    ...
    if (paramBoolean == true) {
      ...
      String str7 = paramBuilder.tab_name;
      if (str7 == null) {
        this.tab_name = "";
      } else {
        this.tab_name = str7;
      ...
      str6 = paramBuilder.ad_bear_context;
      if (str6 == null) {
        this.ad_bear_context = "";
      } else {
        this.ad_bear_context = str6;
      } 
      ...
      String str5 = paramBuilder.ad_bear_sid;
      if (str5 == null) {
        this.ad_bear_sid = "";
      } else {
        this.ad_bear_sid = str5;
      } 
      ...
      String str3 = paramBuilder.top_card_id;
      if (str3 == null) {
        this.top_card_id = "";
      } else {
        this.top_card_id = str3;
      } 
      str3 = paramBuilder.log_param;
      if (str3 == null) {
        this.log_param = "";
      } else {
        this.log_param = str3;
      ...
      String str2 = paramBuilder.frs_tab_type_default;
      if (str2 == null) {
        this.frs_tab_type_default = "";
      } else {
        this.frs_tab_type_default = str2;
      } 
      ...
      this.last_thread_id = ((Builder)str).last_thread_id;
      this.is_default_navtab = ((Builder)str).is_default_navtab;
      ...
      this.is_video_doublerow = ((Builder)str).is_video_doublerow;
      this.top_card_id = ((Builder)str).top_card_id;
      this.log_param = ((Builder)str).log_param;
      this.is_newfeed = ((Builder)str).is_newfeed;
      this.frs_tab_type_default = ((Builder)str).frs_tab_type_default;
      this.forum_name = ((Builder)str).forum_name;
      this.partition_type = ((Builder)str).partition_type;
      this.tid_src = ((Builder)str).tid_src;
      this.nid_src = ((Builder)str).nid_src;
      this.ad_external_info = ((Builder)str).ad_external_info;
      this.user_read_style = ((Builder)str).user_read_style;
