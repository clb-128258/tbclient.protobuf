...
public final class VirtualImageInfo extends Message {
  ...
  public static final String DEFAULT_VIRTUAL_PROFILE_IMAGE_URL = "";
  ...
  public final String virtual_profile_image_url;
  ...
  public VirtualImageInfo(Builder paramBuilder, boolean paramBoolean) {
    ...
    if (paramBoolean == true) {
      ...
      String str3 = paramBuilder.virtual_image_url;
      if (str3 == null) {
      ...
      String str2 = paramBuilder.virtual_background;
      if (str2 == null) {
      ...
      String str1 = paramBuilder.dynamic_virtual_image_url;
      if (str1 == null) {
        this.dynamic_virtual_image_url = "";
      } else {
        this.dynamic_virtual_image_url = str1;
      } 
      str = paramBuilder.virtual_profile_image_url;
      if (str == null) {
        this.virtual_profile_image_url = "";
      } else {
        this.virtual_profile_image_url = str;
      } 
    } else {
      ...
      this.virtual_profile_image_url = ((Builder)str).virtual_profile_image_url;
    } 
  }
  ...
  public static final class Builder extends Message.Builder<VirtualImageInfo> {
    ...
    public String virtual_profile_image_url;
    ...
    public Builder(VirtualImageInfo param1VirtualImageInfo) {
      ...
      this.virtual_profile_image_url = param1VirtualImageInfo.virtual_profile_image_url;
    }
