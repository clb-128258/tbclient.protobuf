...
public final class Anti extends Message {
  ...
  public static final Integer DEFAULT_HAS_SHIELD;
  ...
  public final Integer has_shield;
  ...
  public Anti(Builder paramBuilder, boolean paramBoolean) {
    ...
    if (paramBoolean == true) {
      ...
      Integer integer6 = paramBuilder.ifpost;
      if (integer6 == null) {
        this.ifpost = DEFAULT_IFPOST;
      } else {
        this.ifpost = integer6;
      } 
      integer6 = paramBuilder.ifposta;
      if (integer6 == null) {
        this.ifposta = DEFAULT_IFPOSTA;
      } else {
        this.ifposta = integer6;
      } 
      integer6 = paramBuilder.forbid_flag;
      if (integer6 == null) {
        this.forbid_flag = DEFAULT_FORBID_FLAG;
      } else {
        this.forbid_flag = integer6;
      } 
      ...
      Integer integer5 = paramBuilder.block_stat;
      if (integer5 == null) {
        this.block_stat = DEFAULT_BLOCK_STAT;
      } else {
        this.block_stat = integer5;
      } 
      integer5 = paramBuilder.hide_stat;
      if (integer5 == null) {
        this.hide_stat = DEFAULT_HIDE_STAT;
      } else {
        this.hide_stat = integer5;
      } 
      integer5 = paramBuilder.vcode_stat;
      if (integer5 == null) {
        this.vcode_stat = DEFAULT_VCODE_STAT;
      } else {
        this.vcode_stat = integer5;
      } 
      integer5 = paramBuilder.days_tofree;
      if (integer5 == null) {
        this.days_tofree = DEFAULT_DAYS_TOFREE;
      } else {
        this.days_tofree = integer5;
      } 
      integer5 = paramBuilder.has_chance;
      if (integer5 == null) {
        this.has_chance = DEFAULT_HAS_CHANCE;
      } else {
        this.has_chance = integer5;
      } 
      integer5 = paramBuilder.ifvoice;
      if (integer5 == null) {
        this.ifvoice = DEFAULT_IFVOICE;
      } else {
        this.ifvoice = integer5;
      } 
      ...
      Integer integer4 = paramBuilder.ifaddition;
      if (integer4 == null) {
        this.ifaddition = DEFAULT_IFADDITION;
      } else {
        this.ifaddition = integer4;
      } 
      integer4 = paramBuilder.need_vcode;
      if (integer4 == null) {
        this.need_vcode = DEFAULT_NEED_VCODE;
      } else {
        this.need_vcode = integer4;
      } 
      ...
      Integer integer3 = paramBuilder.reply_private_flag;
      if (integer3 == null) {
        this.reply_private_flag = DEFAULT_REPLY_PRIVATE_FLAG;
      } else {
        this.reply_private_flag = integer3;
      } 
      ...
      Integer integer2 = paramBuilder.multi_delthread;
      if (integer2 == null) {
        this.multi_delthread = DEFAULT_MULTI_DELTHREAD;
      } else {
        this.multi_delthread = integer2;
      } 
      integer2 = paramBuilder.poll_level;
      if (integer2 == null) {
        this.poll_level = DEFAULT_POLL_LEVEL;
      } else {
        this.poll_level = integer2;
      } 
      integer2 = paramBuilder.can_goods;
      if (integer2 == null) {
        this.can_goods = DEFAULT_CAN_GOODS;
      } else {
        this.can_goods = integer2;
      } 
      ...
      Integer integer1 = paramBuilder.user_chat_block;
      if (integer1 == null) {
        this.user_chat_block = DEFAULT_USER_CHAT_BLOCK;
      } else {
        this.user_chat_block = integer1;
      } 
      integer = paramBuilder.has_shield;
      if (integer == null) {
        this.has_shield = DEFAULT_HAS_SHIELD;
      } else {
        this.has_shield = integer;
      } 
    } else {
      ...
      this.has_shield = ((Builder)integer).has_shield;
    } 
  }
  ...
  public static final class Builder extends Message.Builder<Anti> {
    ...
    public Builder(Anti param1Anti) {
      ...
      this.has_shield = param1Anti.has_shield;
    }
