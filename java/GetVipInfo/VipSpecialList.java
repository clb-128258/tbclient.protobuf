...
public final class VipSpecialList extends Message {
  ...
  public static final class Builder extends Message.Builder<VipSpecialList> {
    ...
    public Builder(VipSpecialList param1VipSpecialList) {
      super(param1VipSpecialList);
      if (param1VipSpecialList == null)
        return; 
      this.class_name = param1VipSpecialList.class_name;
      this.class_url_name = param1VipSpecialList.class_url_name;
      this.class_url = param1VipSpecialList.class_url;
      this.item = Message.copyOf(param1VipSpecialList.item);
      this.card_id = param1VipSpecialList.card_id;
    }
