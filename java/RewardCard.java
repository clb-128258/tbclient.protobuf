...
public final class RewardCard extends Message {
  ...
  public RewardCard(Builder paramBuilder, boolean paramBoolean) {
    ...
    if (paramBoolean == true) {
      ...
      str1 = paramBuilder.banner_jump_url;
      if (str1 == null) {
        this.banner_jump_url = "";
      } else {
        this.banner_jump_url = str1;
      } 
      ...
      this.start_text = ((Builder)integer).start_text;
      this.end_text = ((Builder)integer).end_text;
      ...
      this.reward_material = Message.immutableCopyOf(((Builder)integer).reward_material);
      this.total_num = ((Builder)integer).total_num;
      this.head_imgs = Message.immutableCopyOf(((Builder)integer).head_imgs);
      this.join_succ_text = ((Builder)integer).join_succ_text;
      this.banner_jump_url = ((Builder)integer).banner_jump_url;
  ...
  public static final class Builder extends Message.Builder<RewardCard> {
    ...
    public Builder(RewardCard param1RewardCard) {
      ...
      this.type = param1RewardCard.type;
    }
