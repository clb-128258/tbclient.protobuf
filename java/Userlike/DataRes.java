...
public final class DataRes extends Message {
  ...
  public DataRes(Builder paramBuilder, boolean paramBoolean) {
    ...
    if (paramBoolean == true) {
      List<ConcernData> list3 = paramBuilder.thread_info;
      if (list3 == null) {
        this.thread_info = DEFAULT_THREAD_INFO;
      } else {
        this.thread_info = Message.immutableCopyOf(list3);
      } 
      ...
      List<UserList> list2 = paramBuilder.user_list;
      if (list2 == null) {
      ...
      this.user_follow_live = ((Builder)list).user_follow_live;
