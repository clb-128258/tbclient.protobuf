...
public final class LikeForum extends Message {
  ...
  public static final Long DEFAULT_TOP_SORT_VALUE;
  ...
  public LikeForum(Builder paramBuilder, boolean paramBoolean) {
    ...
    if (paramBoolean == true) {
      ...
      integer3 = paramBuilder.member_count;
      if (integer3 == null) {
        this.member_count = DEFAULT_MEMBER_COUNT;
      } else {
        this.member_count = integer3;
      } 
      integer3 = paramBuilder.thread_num;
      if (integer3 == null) {
        this.thread_num = DEFAULT_THREAD_NUM;
      } else {
        this.thread_num = integer3;
      } 
      Long long_2 = paramBuilder.sort_value;
      if (long_2 == null) {
        this.sort_value = DEFAULT_SORT_VALUE;
      } else {
        this.sort_value = long_2;
      } 
      ...
      Integer integer1 = paramBuilder.is_sign;
      if (integer1 == null) {
        this.is_sign = DEFAULT_IS_SIGN;
      } else {
        this.is_sign = integer1;
      } 
      Long long_1 = paramBuilder.top_sort_value;
      if (long_1 == null) {
        this.top_sort_value = DEFAULT_TOP_SORT_VALUE;
      } else {
        this.top_sort_value = long_1;
      } 
      String str1 = paramBuilder.manager_role_name;
      if (str1 == null) {
        this.manager_role_name = "";
      } else {
        this.manager_role_name = str1;
      } 
      integer = paramBuilder.is_forbidden;
      if (integer == null) {
        this.is_forbidden = DEFAULT_IS_FORBIDDEN;
      } else {
        this.is_forbidden = integer;
      } 
    } else {
      ...
      this.top_sort_value = ((Builder)integer).top_sort_value;
      this.manager_role_name = ((Builder)integer).manager_role_name;
  ...
  public static final class Builder extends Message.Builder<LikeForum> {
    ...
    public Builder(LikeForum param1LikeForum) {
      ...
      this.top_sort_value = param1LikeForum.top_sort_value;
      this.manager_role_name = param1LikeForum.manager_role_name;
      this.is_forbidden = param1LikeForum.is_forbidden;
    }
