...
public final class ChatroomMEMsgInfo extends Message {
  ...
  public ChatroomMEMsgInfo(Builder paramBuilder, boolean paramBoolean) {
    ...
    if (paramBoolean == true) {
      ...
      str = paramBuilder.special_msg_type;
      if (str == null) {
        this.special_msg_type = "";
      } else {
        this.special_msg_type = str;
      } 
    } else {
      this.from_uid = ((Builder)str).from_uid;
      this.from_name = ((Builder)str).from_name;
      this.content = ((Builder)str).content;
      this.msg_id = ((Builder)str).msg_id;
      this.special_msg = ((Builder)str).special_msg;
      this.special_msg_type = ((Builder)str).special_msg_type;
    } 
  }
