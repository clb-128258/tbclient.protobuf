...
public final class ApkDetail extends Message {
  ...
  public ApkDetail(Builder paramBuilder, boolean paramBoolean) {
    ...
    if (paramBoolean == true) {
      ...
      Integer integer3 = paramBuilder.version_code;
      if (integer3 == null) {
        this.version_code = DEFAULT_VERSION_CODE;
      } else {
        this.version_code = integer3;
      } 
      ...
      Integer integer2 = paramBuilder.need_network;
      if (integer2 == null) {
        this.need_network = DEFAULT_NEED_NETWORK;
      } else {
        this.need_network = integer2;
      } 
      integer2 = paramBuilder.need_inner_buy;
      if (integer2 == null) {
        this.need_inner_buy = DEFAULT_NEED_INNER_BUY;
      } else {
        this.need_inner_buy = integer2;
      } 
      ...
      Integer integer1 = paramBuilder.pkg_source;
      if (integer1 == null) {
        this.pkg_source = DEFAULT_PKG_SOURCE;
      } else {
        this.pkg_source = integer1;
      } 
      str = paramBuilder.app_effect;
      if (str == null) {
        this.app_effect = "";
      } else {
        this.app_effect = str;
      ...
      this.publisher = ((Builder)str).publisher;
      ...
      this.need_network = ((Builder)str).need_network;
      this.need_inner_buy = ((Builder)str).need_inner_buy;
  ...
  public static final class Builder extends Message.Builder<ApkDetail> {
    ...
    public Builder(ApkDetail param1ApkDetail) {
      ...
      this.app_effect = param1ApkDetail.app_effect;
    }
