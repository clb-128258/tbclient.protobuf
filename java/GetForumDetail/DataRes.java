...
public final class DataRes extends Message {
  ...
  public static final String DEFAULT_FORUM_TYPE = "";
  ...
  public final String forum_type;
  ...
  public DataRes(Builder paramBuilder, boolean paramBoolean) {
    ...
    if (paramBoolean == true) {
      ...
      String str1 = paramBuilder.is_bazhu_show;
      if (str1 == null) {
        this.is_bazhu_show = "";
      } else {
        this.is_bazhu_show = str1;
      } 
      ...
      this.is_bawu_show = ((Builder)str).is_bawu_show;
      this.bz_apply_info = ((Builder)str).bz_apply_info;
      this.is_complaint_show = ((Builder)str).is_complaint_show;
      this.pribz_apply_info = ((Builder)str).pribz_apply_info;
      this.election_tab = ((Builder)str).election_tab;
      this.is_forum_data_show = ((Builder)str).is_forum_data_show;
      this.forum_data = ((Builder)str).forum_data;
      this.bawu_actions = Message.immutableCopyOf(((Builder)str).bawu_actions);
      this.apply_status = ((Builder)str).apply_status;
      this.bazhu_university = ((Builder)str).bazhu_university;
      this.bazhu_grade = ((Builder)str).bazhu_grade;
      this.is_forum_card_enable = ((Builder)str).is_forum_card_enable;
      this.bawu_thrones = ((Builder)str).bawu_thrones;
      this.is_bazhu_show = ((Builder)str).is_bazhu_show;
      this.hot_user_entry = ((Builder)str).hot_user_entry;
      this.small_app = ((Builder)str).small_app;
      this.forum_member = ((Builder)str).forum_member;
      this.forum_type = ((Builder)str).forum_type;
    } 
  }
  ...
  public static final class Builder extends Message.Builder<DataRes> {
    ...
    public Builder(DataRes param1DataRes) {
      ...
      this.forum_type = param1DataRes.forum_type;
    }
