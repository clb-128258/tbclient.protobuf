...
public final class FrsTabInfo extends Message {
  ...
  public static final Integer DEFAULT_NET_TAB_TYPE;
  
  public static final Integer DEFAULT_NO_CAN_POST;
  
  public static final Integer DEFAULT_NO_CAN_REFRESH;
  
  public static final List<PartitionMenu> DEFAULT_PARTITION_MENU;
  
  public static final Integer DEFAULT_SHOW_STYLE_SWITCH;
  
  public static final List<SortButton> DEFAULT_SORT_MENU;
  
  public static final List<TabMenu> DEFAULT_SUB_TAB_LIST;
  ...
  public final Integer no_can_post;
  
  @ProtoField(tag = 24, type = Message.Datatype.INT32)
  public final Integer no_can_refresh;
  
  @ProtoField(label = Message.Label.REPEATED, tag = 21)
  public final List<PartitionMenu> partition_menu;
  
  @ProtoField(tag = 22, type = Message.Datatype.INT32)
  public final Integer show_style_switch;
  ...
  static {
    ...
    DEFAULT_NET_TAB_TYPE = integer;
    DEFAULT_SORT_MENU = Collections.emptyList();
    DEFAULT_SUB_TAB_LIST = Collections.emptyList();
    DEFAULT_PARTITION_MENU = Collections.emptyList();
    DEFAULT_SHOW_STYLE_SWITCH = integer;
    DEFAULT_NO_CAN_POST = integer;
    DEFAULT_NO_CAN_REFRESH = integer;
  }
  ...
  public FrsTabInfo(Builder paramBuilder, boolean paramBoolean) {
    ...
    if (paramBoolean == true) {
      ...
      integer5 = paramBuilder.tab_type;
      if (integer5 == null) {
        this.tab_type = DEFAULT_TAB_TYPE;
      } else {
        this.tab_type = integer5;
      } 
      ...
      Integer integer4 = paramBuilder.is_general_tab;
      if (integer4 == null) {
        this.is_general_tab = DEFAULT_IS_GENERAL_TAB;
      } else {
        this.is_general_tab = integer4;
      } 
      ...
      Integer integer3 = paramBuilder.tab_version;
      if (integer3 == null) {
        this.tab_version = DEFAULT_TAB_VERSION;
      } else {
        this.tab_version = integer3;
      } 
      integer3 = paramBuilder.is_default;
      if (integer3 == null) {
        this.is_default = DEFAULT_IS_DEFAULT;
      } else {
        this.is_default = integer3;
      } 
      integer3 = paramBuilder.need_page;
      if (integer3 == null) {
        this.need_page = DEFAULT_NEED_PAGE;
      } else {
        this.need_page = integer3;
      } 
      ...
      Integer integer2 = paramBuilder.is_no_show_publisher;
      if (integer2 == null) {
        this.is_no_show_publisher = DEFAULT_IS_NO_SHOW_PUBLISHER;
      } else {
        this.is_no_show_publisher = integer2;
      } 
      integer2 = paramBuilder.is_no_show_in_publisher;
      if (integer2 == null) {
        this.is_no_show_in_publisher = DEFAULT_IS_NO_SHOW_IN_PUBLISHER;
      } else {
        this.is_no_show_in_publisher = integer2;
      } 
      integer2 = paramBuilder.net_tab_type;
      if (integer2 == null) {
        this.net_tab_type = DEFAULT_NET_TAB_TYPE;
      } else {
        this.net_tab_type = integer2;
      } 
      List<SortButton> list2 = paramBuilder.sort_menu;
      if (list2 == null) {
        this.sort_menu = DEFAULT_SORT_MENU;
      } else {
        this.sort_menu = Message.immutableCopyOf(list2);
      } 
      List<TabMenu> list1 = paramBuilder.sub_tab_list;
      if (list1 == null) {
        this.sub_tab_list = DEFAULT_SUB_TAB_LIST;
      } else {
        this.sub_tab_list = Message.immutableCopyOf(list1);
      } 
      List<PartitionMenu> list = paramBuilder.partition_menu;
      if (list == null) {
        this.partition_menu = DEFAULT_PARTITION_MENU;
      } else {
        this.partition_menu = Message.immutableCopyOf(list);
      } 
      Integer integer1 = paramBuilder.show_style_switch;
      if (integer1 == null) {
        this.show_style_switch = DEFAULT_SHOW_STYLE_SWITCH;
      } else {
        this.show_style_switch = integer1;
      } 
      integer1 = paramBuilder.no_can_post;
      if (integer1 == null) {
        this.no_can_post = DEFAULT_NO_CAN_POST;
      } else {
        this.no_can_post = integer1;
      } 
      integer = paramBuilder.no_can_refresh;
      if (integer == null) {
        this.no_can_refresh = DEFAULT_NO_CAN_REFRESH;
      } else {
        this.no_can_refresh = integer;
      } 
    } else {
      ...
      this.net_tab_type = ((Builder)integer).net_tab_type;
      this.sort_menu = Message.immutableCopyOf(((Builder)integer).sort_menu);
      this.sub_tab_list = Message.immutableCopyOf(((Builder)integer).sub_tab_list);
      this.partition_menu = Message.immutableCopyOf(((Builder)integer).partition_menu);
      this.show_style_switch = ((Builder)integer).show_style_switch;
      this.no_can_post = ((Builder)integer).no_can_post;
      this.no_can_refresh = ((Builder)integer).no_can_refresh;
    } 
  }
  ...
  public static final class Builder extends Message.Builder<FrsTabInfo> {
    ...
    public Integer no_can_post;
    
    public Integer no_can_refresh;
    
    public List<PartitionMenu> partition_menu;
    
    public Integer show_style_switch;
    ...
    public Builder(FrsTabInfo param1FrsTabInfo) {
      ...
      this.net_tab_type = param1FrsTabInfo.net_tab_type;
      this.sort_menu = Message.copyOf(param1FrsTabInfo.sort_menu);
      this.sub_tab_list = Message.copyOf(param1FrsTabInfo.sub_tab_list);
      this.partition_menu = Message.copyOf(param1FrsTabInfo.partition_menu);
      this.show_style_switch = param1FrsTabInfo.show_style_switch;
      this.no_can_post = param1FrsTabInfo.no_can_post;
      this.no_can_refresh = param1FrsTabInfo.no_can_refresh;
    }
