...
public final class OriginThreadInfo extends Message {
  ...
  public OriginThreadInfo(Builder paramBuilder, boolean paramBoolean) {
    ...
    if (paramBoolean == true) {
      ...
      List<Media> list6 = paramBuilder.media;
      if (list6 == null) {
        this.media = DEFAULT_MEDIA;
      } else {
        this.media = Message.immutableCopyOf(list6);
      } 
      List<Abstract> list5 = paramBuilder._abstract;
      if (list5 == null) {
        this._abstract = DEFAULT_ABSTRACT;
      } else {
        this._abstract = Message.immutableCopyOf(list5);
      } 
      ...
      List<Voice> list4 = paramBuilder.voice_info;
      if (list4 == null) {
      ...
      List<PbContent> list3 = paramBuilder.content;
      if (list3 == null) {
      ...
      List<PbLinkInfo> list1 = paramBuilder.pb_link_info;
      if (list1 == null) {
      ...
      list = paramBuilder.voice_room_link_info;
      if (list == null) {
        this.voice_room_link_info = DEFAULT_VOICE_ROOM_LINK_INFO;
      } else {
        this.voice_room_link_info = Message.immutableCopyOf(list);
      } 
    } else {
      ...
      this.is_ugc = ((Builder)list).is_ugc;
      this.ori_ugc_info = ((Builder)list).ori_ugc_info;
      ...
      this.good_types = ((Builder)list).good_types;
      this.top_types = ((Builder)list).top_types;
  ...
  public static final class Builder extends Message.Builder<OriginThreadInfo> {
    ...
    public Builder(OriginThreadInfo param1OriginThreadInfo) {
      ...
      this.voice_room_link_info = Message.copyOf(param1OriginThreadInfo.voice_room_link_info);
    }
