...
public final class LiveFuseForumData extends Message {
  ...
  public static final List<TagLabelInfo> DEFAULT_LABEL_INFOS;
  ...
  static {
    ...
    DEFAULT_LABEL_INFOS = Collections.emptyList();
  }
  ...
  public LiveFuseForumData(Builder paramBuilder, boolean paramBoolean) {
    ...
    if (paramBoolean == true) {
      ...
      List<String> list1 = paramBuilder.head_img;
      if (list1 == null) {
        this.head_img = DEFAULT_HEAD_IMG;
      } else {
        this.head_img = Message.immutableCopyOf(list1);
      } 
      ...
      Integer integer1 = paramBuilder.head_img_style;
      if (integer1 == null) {
        this.head_img_style = DEFAULT_HEAD_IMG_STYLE;
      } else {
        this.head_img_style = integer1;
      } 
      List<TagLabelInfo> list = paramBuilder.label_infos;
      if (list == null) {
        this.label_infos = DEFAULT_LABEL_INFOS;
      } else {
        this.label_infos = Message.immutableCopyOf(list);
      } 
      this.novel = paramBuilder.novel;
    } else {
      this.online_users = paramBuilder.online_users;
      this.head_img = Message.immutableCopyOf(paramBuilder.head_img);
      this.title = Message.immutableCopyOf(paramBuilder.title);
      this.schema = paramBuilder.schema;
      this.type = paramBuilder.type;
      this.yyext = paramBuilder.yyext;
      this.icon_url = paramBuilder.icon_url;
      this.bjimg_dark_big = paramBuilder.bjimg_dark_big;
      this.bjimg_light_big = paramBuilder.bjimg_light_big;
      this.bjimg_dark_small = paramBuilder.bjimg_dark_small;
      this.bjimg_light_small = paramBuilder.bjimg_light_small;
      this.head_img_style = paramBuilder.head_img_style;
      this.label_infos = Message.immutableCopyOf(paramBuilder.label_infos);
      this.novel = paramBuilder.novel;
    } 
  }
  ...
  public static final class Builder extends Message.Builder<LiveFuseForumData> {
    ...
    public Builder(LiveFuseForumData param1LiveFuseForumData) {
      ...
      this.label_infos = Message.copyOf(param1LiveFuseForumData.label_infos);
      this.novel = param1LiveFuseForumData.novel;
    }
